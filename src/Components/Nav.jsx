...
function Nav() {
    ...
    return (
        <>
            ...
            <div className='flex bg-white justify-center gap-[12%] items-center pt-0 h-[70px] lg:flex lg:justify-center md:mx-10 lg:mx-0  lg:w-full md:gap-[5%] lg:gap-x-[8%] xl:gap-[18%] lg:items-center lg:mt- fixed z-40 md:top-44 top-16 py-4 lg:top-36 '>
            ...
            <div 
                className={`absolute top-[20%] left-0 -z-10 w-full bg-[#07294D] text-white px-4 py-4 transition-all duration-500 ease-in opacity-0${isSidebarOpen ? 'transform translate-y-0  opacity-100' : 'transform -translate-y-full -top-[100%] h-0 opacity-0 '}`}
            >
                {isSidebarOpen && (
