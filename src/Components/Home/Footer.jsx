...
function Footer() {
    return (
        <div className='bg-[#07294C] font-Roboto md:px-3 lg:px-20 lg:grid lg:grid-cols-3 items-start lg:h-[14rem] 2xl:h-[16rem] xl:h-[rem] lg:pl-10 xl:pl-10 xl:px-20 2xl:px-0 2xl:pl-0  '>
            <div className=' lg:ml-10 xl:ml-28 2xl:ml-56 mx-8  flex flex-col gap-3 lg:gap-6 pt-5  md:flex '>
            ...
            <div className='text-white mx-5 lg:px-5 lg:mx-5 lg:mr-16 xl:mr-36 2xl:mr-60 2xl:-mx-10  flex flex-col md:gap-2 lg:gap-5 xl:gap-5 '>
            ...
            <div className='text-white mx-5 flex flex-col gap-3 md:gap-6 xl:gap-4 2xl:relative 2xl:right-28 2xl:w 2xl:mx-0 text-[15px] md:text-[16px] pb-12 lg:pb-0 lg:px-0 lg:mx-0 lg:gap-[12px]'>
                <h2 className='text-[18px] font-montserrat my-5 md:text-2xl 2xl:text-3xl'>Contact Us</h2>
