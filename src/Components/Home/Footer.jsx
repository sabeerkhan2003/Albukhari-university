...
function Footer() {
    return (
        <div className='bg-[#07294C] font-Roboto px-5 md:px-3 lg:px-20 lg:grid lg:grid-cols-3 items-start py-8 lg:py-4 h-fit lg:h-[14rem] 2xl:h-[16rem] xl:h-[13rem] lg:pl-10 xl:pl-0 xl:px-0  2xl:px-0 2xl:pl-0 xl:items-center '>
            ...
            <div className='text-white mx-5 lg:px-5 lg:mx-5 xl:px-0 lg:mr-16 xl:mr-52 2xl:mr-80 2xl:-mx-10 2xl:ml-16  flex flex-col md:gap-2 lg:gap-5 xl:gap-5 '>
                ...
                <ul className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-2 gap-y-2 mr-16 md:mr-0  lg:mt-0 text-[15px] md:text-[14px] md:pl-10 lg:pl-0'>
            ...
            <div className='text-white mx-5 flex flex-col gap-y-6 md:gap-6 xl:gap-5 xl:relative xl:right-24 xl:bottom-2  2xl:mx-0 text-[15px] w-full xl:w-[470px] 2xl:w-[800px] md:text-[16px]  lg:pb-0 lg:px-0 lg:mx-0 lg:gap-[12px]'>
                <h2 className='text-[18px] md:text-2xl font-montserrat mb-8 pt-8 lg:mb-0 lg:pt-0  lg:my-5 xl:my-0 2xl:text-3xl '>Contact Us</h2>
                   <div className='hidden xl:flex xl:flex-col xl:gap-4'>
                <div className='flex md:items-center lg:items-center gap-2 md:gap-3 hover:text-[#125B9E] hover:pl-2 hover:transition-all duration-300  '>
