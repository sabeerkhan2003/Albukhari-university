...
function Founder() {
  ...
  return (<><div className='text-center mt-8'>
    <Admission_button />
    <h3 className='text-[24px] font-semibold my-5 lg:my-5'>
      WELCOME TO <span className='text-uppercase text-red-500'>Kilakarai Bukhari Aalim Arabic College</span>
    </h3>
    </div>
    <div className='flex justify-center flex-col gap-8 lg:justify-center mt-8 md:gap-16 lg:gap-32  md:flex-row items-center mx-4'>

      <div className='border-8 border-[#07294D]'>

        <img src={founder} alt="principal" className='w-[180px]  lg:w-[420px] lg:border-8 border-[#07294D] lg:p-10 ' /></div>
